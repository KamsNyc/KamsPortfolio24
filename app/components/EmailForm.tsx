  ...
  return (
    <div id='contact' className="md:flex justify-between">
      ...
      <h1 className="heading font-bold text-[32px] md:text-[56px] tracking-tighter uppercase">
          ...
          {/* Contact email */}
        <p className='paragraph text-[18px] text-[#c7c7c7]'>Say hello at <a href='mailto:KamsNyc@gmail.com' target='_blank' className='border-b border-[#d3e97a] hover:text-[#c8e45b]'>
    KamsNyc@gmail.com
  </a></p>
  {/* Resume */}
  <p className='paragraph text-[18px] pt-[4px] md:pt-[4px] text-[#c7c7c7]'>
  For more info, here's my <a
href='/resume.pdf'
    target='_blank'
  ...
  />
    ...
    <form onSubmit={handleSubmit} className="flex flex-col space-y-[24px] ">
      ...
      <label className='text-[16px] paragraph text-[#c7c7c7] '>
        ...
        <div className="">
      <button type="submit" className="bg-[#D3E97A] text-[#0a0a0a] paragraph font-bold leading-[100%] px-[40px] py-[20px] rounded-[100px] uppercase hover:bg-[#c8e45b]">Submit</button>
      </div>
    </form>
    </div>
    </div>
